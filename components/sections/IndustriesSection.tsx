...
import { GraduationCap, ShoppingBag, Building2, UtensilsCrossed, Package, Briefcase } from 'lucide-react'
...
const industries = [
  ...
  },
  {
    ...
    metrics: ['8x revenue growth', '4.5x average ROAS'],
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-xl text-black/70 max-w-3xl mx-auto">
            From startups to enterprises, we've helped brands across diverse sectors achieve remarkable growth
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg text-black/60">
            Don't see your industry? <span className="font-bold text-black">We adapt our strategies to any sector.</span>
          </p>
        </motion.div>
      </div>
    </section>
