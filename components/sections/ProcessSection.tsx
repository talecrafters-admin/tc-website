...
const steps = [
  {
    ...
    detail: 'Deep dive into your current campaigns, targeting, and creatives to identify what\'s burning money.',
  },
  {
    number: '02',
    icon: Lightbulb,
    ...
    detail: 'Build a data-driven strategy tailored to your business goals and target audience.',
  },
  {
    number: '03',
    icon: Sparkles,
    ...
    detail: 'Design and test high-converting ad creatives that make your audience stop and click.',
  },
  {
    number: '04',
    icon: BarChart3,
    ...
    detail: 'Continuous testing and optimization to maximize ROAS and scale what works.',
  },
]
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h2 className="font-heading text-4xl md:text-6xl font-bold mb-4">
            How We Turn ₹1 Into ₹8
          </h2>
          <p className="text-xl text-black/70">
            Our proven 4-step process for performance marketing
          </p>
        </motion.div>

        <div className="relative">
          {/* Connection line */}
          <div className="hidden lg:block absolute top-24 left-0 right-0 h-1 bg-black" style={{ top: '120px' }} />
