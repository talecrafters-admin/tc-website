...
import { Facebook, Palette, Target, Search, Megaphone, Globe, Smartphone, Camera, Brain, Linkedin, MapPin } from 'lucide-react'
...
const services = [
  ...
  },
  {
    ...
    description: 'B2B growth & optimization',
    color: 'accent3' as const,
  },
]
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              <Link href="/services">
                <Card variant={service.color} className="h-full cursor-pointer group-hover:scale-105 transition-transform">
