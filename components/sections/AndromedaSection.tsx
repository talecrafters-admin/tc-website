...
export default function AndromedaSection() {
  return (
    <section className="py-20 px-6 lg:px-8 bg-secondary relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            The Andromeda update revolutionized how Meta's AI optimizes campaigns. 
            We've adapted our strategies to leverage these changes, resulting in 
            2-3x better performance for our clients.
          </p>
