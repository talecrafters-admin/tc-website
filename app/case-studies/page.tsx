...
export const metadata: Metadata = {
  ...
  description:
    "From social media growth to app launches, see how we've helped brands across Education, FMCG, Real Estate, F&B, D2C, and B2B sectors achieve remarkable growth.",
};
...
const caseStudies = [
  {
    ...
    location: "Mumbai",
    challenge:
      "Low engagement on social media (1.2%) and high customer acquisition costs (₹2,800 per customer)",
    solution:
      "Complete social media revamp with Reels strategy, influencer collaborations, and targeted Meta campaigns",
    growth: "45K→180K followers",
    engagement: "1.2%→8.5%",
    roas: "4.2x",
    duration: "4 months",
    testimonial:
      "TaleCrafters transformed our Instagram from a ghost town to a thriving community. Sales followed naturally.",
    author: "Priya Sharma",
    position: "Founder",
    results: [
  ...
  },
  {
    ...
    location: "Bangalore",
    challenge:
      "Poor LinkedIn presence and struggling to generate qualified B2B leads",
    solution:
      "LinkedIn optimization, thought leadership content, and targeted LinkedIn Ads campaigns",
    leads: "580",
    qualified: "87% qualified",
    growth: "2.5K→15K",
    duration: "5 months",
    testimonial:
      "Our LinkedIn transformed from a dead profile to our #1 lead source. Quality of leads is incredible.",
    author: "Rajesh Kumar",
    position: "CMO",
    results: [
  ...
  },
  {
    ...
    solution:
      "Full-service launch: branding, social media, local SEO, food photography, and influencer marketing",
    revenue: "₹65L",
    orders: "12K+",
    gmb: "#1 ranking",
    duration: "6 months",
    testimonial:
      "Launched from scratch to market leader in 6 months. They handled everything—from photos to ads.",
    author: "Ananya Reddy",
    position: "Co-founder",
    results: [
  ...
  },
  {
    ...
    location: "Pune",
    challenge:
      "Premium project launch requiring qualified leads and brand positioning",
    solution:
      "Multi-channel strategy: TV ads, newspaper campaigns, digital marketing, and professional property shoots",
    leads: "450+",
    sales: "₹18Cr",
    traditional: "TV + Print",
    duration: "3 months",
    testimonial:
      "Blend of traditional and digital worked perfectly. Sold 60% inventory before project completion.",
  ...
  },
  {
    ...
    solution:
      "SEO overhaul, content marketing, blog strategy, and organic social media growth",
    traffic: "5x organic traffic",
    leads: "2,400+",
    cpl: "₹85",
    duration: "8 months",
    testimonial:
      "Organic traffic became our primary growth driver. Finally, sustainable growth without burning cash.",
  ...
  },
  {
    ...
    location: "Chennai",
    challenge:
      "Regional brand wanting to expand to national markets with modern online presence",
    solution:
      "E-commerce website development, Amazon & Flipkart optimization, influencer campaigns, and regional ads",
    expansion: "5→15 cities",
    revenue: "3.5x growth",
    platforms: "Web + Marketplaces",
    duration: "12 months",
    testimonial:
      "Helped us go from regional player to national brand. Sales tripled and we're in 15 cities now.",
    ...
    color: "primary" as const,
    image:
      "https://images.unsplash.com/photo-1556742521-9713bf272865?w=800&h=400&fit=crop",
  },
  {
    id: 7,
    ...
    location: "Hyderabad",
    challenge:
      "New mobile app launch needing users, engagement, and brand awareness",
    solution:
      "Mobile app development support, app store optimization, social media challenges, and influencer partnerships",
    downloads: "50K+",
    viral: "2 viral challenges",
    retention: "45%",
    duration: "6 months",
    testimonial:
      "Two viral challenges put us on the map. App downloads exploded and retention is best in category.",
    author: "Arjun Patel",
  ...
  },
  {
    ...
    location: "Jaipur",
    challenge:
      "Beautiful products but low website traffic and almost no social media presence",
    solution:
      "Professional product photoshoots, Instagram aesthetic curation, Pinterest strategy, and SEO optimization",
    followers: "8K→85K",
    revenue: "₹1.8Cr",
    pinterest: "500K impressions",
    duration: "7 months",
    testimonial:
      "They made our products look like art. Instagram and Pinterest became our biggest sales drivers.",
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-black/70 max-w-3xl mx-auto">
              From viral social campaigns to complete market expansion—see what
              we've achieved across diverse industries.
            </p>
          </div>
